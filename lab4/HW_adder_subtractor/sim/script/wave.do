...
add wave -noupdate -expand -group {display in} -radix States /counter_display_tb/uut/left_display_output
add wave -noupdate -expand -group {display in} -radix States /counter_display_tb/uut/center_display_output
add wave -noupdate -expand -group {display in} -radix States /counter_display_tb/uut/right_display_output
...
add wave -noupdate -group {display out} -radix States /counter_display_tb/uut/display_one
add wave -noupdate -group {display out} -radix States /counter_display_tb/uut/display_two
add wave -noupdate -group {display out} -radix States /counter_display_tb/uut/display_three
add wave -noupdate -group input_signals /counter_display_tb/uut/add_button
add wave -noupdate -group input_signals /counter_display_tb/uut/subtract_button
add wave -noupdate -group input_signals -radix unsigned /counter_display_tb/uut/input_a
add wave -noupdate -group input_signals -radix unsigned /counter_display_tb/uut/input_b
